...
- Docker [luoyulanye2005/frps](https://hub.docker.com/r/luoyulanye2005/frps)
...
安装
```shell
wget https://raw.githubusercontent.com/luoyulanye2005/frps/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
# 以下为国内镜像
wget https://github.ioiox.com/luoyulanye2005/frps/raw/branch/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
...
卸载
```shell
wget https://raw.githubusercontent.com/luoyulanye2005/frps/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
# 以下为国内镜像
wget https://github.ioiox.com/luoyulanye2005/frps/raw/branch/master/frps_linux_uninstall.sh && chmod +x frps_linux_uninstall.sh && ./frps_linux_uninstall.sh
```
...
`REPO=luoyulanye2005/frps` 由于 **fork** 到你自己的仓库,需修改`luoyulanye2005`为你的 GitHub 账号ID.

#### 执行一键脚本
修改以下脚本链接中的`luoyulanye2005`为你的 GitHub 账号 ID 后,执行即可.
```shell
wget https://raw.githubusercontent.com/luoyulanye2005/frps/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
#### 卸载脚本
...
```shell
git clone https://github.com/luoyulanye2005/frps
# git clone 本仓库
git clone https://github.ioiox.com/luoyulanye2005/frps
# 国内镜像
...
- GitHub [luoyulanye2005/frps](https://github.com/luoyulanye2005/frps)
- Docker Hub [luoyulanye2005/frps](https://hub.docker.com/r/luoyulanye2005/frps)
